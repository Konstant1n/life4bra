...
$options1[] = array("label" => __("Site Loader Settings",'limo'),
    "title" => __("Site Loader Settings",'limo'),
    "type" => "Title-1");
$options1[] = array("id" => "tmpmela_show_site_loader",
    "label" => __("Show Site Loader",'limo'),
    "type" => "select",
    "description" => __("Displays Site Loader.",'limo'),
    "options" => array('no' => 'No','yes' => 'Yes'));
$options1[] = array("label" => __("General Settings",'limo'),
    "title" => __("General Settings",'limo'),
    "type" => "Title-1");
